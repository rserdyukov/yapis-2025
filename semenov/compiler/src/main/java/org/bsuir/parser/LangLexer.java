...
public class LangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "MUL", "DIV", "MOD", "PLUS", "MINUS", "LT", "GT", "LE", "GE", 
			"EQ", "NEQ", "AND", "OR", "NOT", "INC", "DEC", "PLUS_ASSIGN", "MINUS_ASSIGN", 
			"MUL_ASSIGN", "DIV_ASSIGN", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "COMMA", 
			"BOOLEAN", "INT", "STRING", "ID", "NEWLINE", "WS", "LINE_COMMENT"
		};
	}
